    ...
    <div className="dashboard-card p-6 relative">
      ...
      <div className="flex gap-4 mb-6">
        <button
          ...
          className={`buy-sell-btn flex-1 font-medium text-center py-2.5 px-4 rounded-3xl transition-all ${
            selectedTab === "buy"
              ? "buy-sell-btn-active"
              : "buy-sell-btn-inactive"
          }`}
        >
          {selectedTab === "buy" && (
            <>
              <span className="buy-sell-btn-effect"></span>
              <span className="buy-sell-btn-tint"></span>
              <span className="buy-sell-btn-shine"></span>
            </>
          )}
          <span className="buy-sell-btn-content">Buy</span>
        </button>
        <button
          onClick={() => setSelectedTab("sell")}
          className={`buy-sell-btn flex-1 font-medium text-center py-2 px-4 rounded-3xl transition-all ${
            selectedTab === "sell"
              ? "buy-sell-btn-active"
              : "buy-sell-btn-inactive"
          }`}
        >
          ...
          <span className="buy-sell-btn-content">Sell</span>
        </button>
      </div>
      ...
      <div className=" flex gap-3 flex-col">
        ...
        <div className="pt-4 border p-3 bg-white/6 rounded-lg border-gray-700">
          ...
          <p className="text-white/70 text-xs">
            Fee: $0.00 (Amn token discount applied)
          </p>
        </div>
