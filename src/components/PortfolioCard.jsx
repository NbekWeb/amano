...
const PortfolioCard = ({ title, value, subtitle, icon, showTrend }) => {
  ...
  return (
    <div className="dashboard-card  p-6 relative h-fit w-full flex gap-3">
      <div className="stat-card-blur  w-40   h-12 absolute top-10 right-10 flex"></div>
      <div className="flex items-start justify-between mb-4">
        <LiquidGlassButton width={44} height={44} radius="full">
          <IconComponent />
        </LiquidGlassButton>
      </div>
      <div>
